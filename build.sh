...
echo "  ./bin/sitemerge export-import  --action import --host 127.0.0.1 --port 30388 --user root --password --database test --table bank0 --dst-host 127.0.0.1 --dst-port 31980 --dst-user root --dst-password  --dst-database test --threads 8"